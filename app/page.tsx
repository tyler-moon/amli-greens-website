    ...
    <>
      ...
      <main id="home">
        <section className="hero hero--greens">
          <video className="hero__video" autoPlay muted loop playsInline poster="/images/greens-hero-poster.jpg" aria-hidden="true">
            <source src="/videos/greens-hero.mp4" type="video/mp4" />
          </video>
